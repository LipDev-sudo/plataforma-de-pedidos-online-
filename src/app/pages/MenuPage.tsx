    ...
    <div className="pb-24">
      ...
      <div className="px-4 pt-6 pb-4">
        ...
        <div className="relative">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-[#9A9A9A]" />
          <input
            type="text"
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            placeholder="Buscar no cardapio..."
            className="w-full bg-[#1A1A1A] rounded-xl pl-10 pr-4 py-3 text-[14px] text-foreground placeholder:text-[#9A9A9A] border border-white/[0.06] focus:border-primary/40 focus:outline-none focus:shadow-[0_0_12px_rgba(234,29,44,0.15)] transition-all"
          />
        </div>
      </div>
